  ...
  <div class="container-fluid mb20px">
      <h3 class="nwt-category categorypopup"><small>현황통계&nbsp;&nbsp;>&nbsp;&nbsp;미수금액 현황&nbsp;&nbsp;></small>상세리스트</h3>
    </div>
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <form class="form-inline" id="searchForm">
                    <input type="hidden" class="form-control" name="garageID" id="garageID" value="<?php echo $_REQUEST['garageID']?>">                
                    <fieldset>
                        <legend>조건검색</legend>
