...
<div class="modal-add" id="add-new">
    <form class="form-horizontal" name="editForm" id="editForm" method="post">
        ...
        <div class="modal-body">   
            ...
            <div class="row">
                <!-- 입고일 -->
                <div class="col-md-1"><label for="issueDate">입고일</label></div>
                <div class="col-md-3">
                ...
                <!-- 메모 -->
                <div class="col-md-1"><label for="STOCK_MEMO">메모</label></div>
                <div class="col-md-6"><input type="text" class="form-control" id="STOCK_MEMO" name="STOCK_MEMO" placeholder="입력"></div>
            </div>      
