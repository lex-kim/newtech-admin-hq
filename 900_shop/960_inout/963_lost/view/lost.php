<!-- 페이지 카테고리 -->
  <div class="container-fluid mb20px">
    <h3 class="nwt-category"><small>입출고 관리&nbsp;&nbsp;></small>분실/폐기 관리</h3>
  </div>
                        ...
                        <div class="row frm-last-row">
                          ...
                          <div class="col-md-2 frmGroup3">
                            ...
                            <select class="form-control input-md" id="dateField" name="dateField">
                              ...
                              <option value="ES_ISSUE_DATE">분실/폐기일</option>
                          ...
                          <!-- 처리구분 -->
                          <div class="col-md-1">
                            <label for="lostDisposalID" class="sr-only">처리구분</label>
                                <select class="form-control" name="lostDisposalID" id="lostDisposalID">
