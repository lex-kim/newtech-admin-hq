...
<div class="modal-add" id="add-new">
    <form class="form-horizontal" name="editForm" id="editForm" method="post">
        ...
        <h4 class="modal-title">분실/폐기 등록</h4>  
        </div>
        ...
        <div class="modal-body">   
            ...
            <div class="row">
                <!-- 처리일 -->
                <div class="col-md-1"><label for="issueDate">분실/<br>폐기일</label></div>
                <div class="col-md-2">
                    <input type="text" class="form-control" id="issueDate" name="issueDate" placeholder="현재일-변경가능" required/>
                ...
                <!-- 메모 -->
                <div class="col-md-1"><label for="SALESMAN_MEMO">메모</label></div>
                <div class="col-md-5">
                    <input type="text" class="form-control" id="SALESMAN_MEMO" name="SALESMAN_MEMO" placeholder="입력">
                    <input type="hidden" class="form-control" id="SALESMAN_ID" name="SALESMAN_ID" placeholder="직원아이디">
                </div>

            </div> 

            <div class="row">
                <div class="col-md-1"><label for="SALESMAN_NM">처리구분</label></div>
                <div class="col-md-2">
                    <select class="form-control" name="lostDisposalID" id="lostDisposalID" required>
                            <?php echo getOption($this->optionArray['EC_DISPOSAL_STATUS'], "처리구분" , $buyInfo['lostDisposalID']) ?>
                    </select>  
                </div>
                    ...
                    <tbody id="lostTable">
                        <?php
                            echo "<script>
                                    ...
                                    lostCodeDomainInfo = ".json_encode($this->optionArray['EC_DISPOSAL_STATUS'],true) .";
