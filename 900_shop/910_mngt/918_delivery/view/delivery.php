  ...
  <div class="container-fluid mb20px">
    <h3 class="nwt-category"><small>상품관리&nbsp;&nbsp;></small>배송정책관리</h3>
  </div>
                  ...
                  <fieldset>
                      ...
                      <div class="frm-wrap">
                        ...
                        <div class="row frm-last-row">
                          ...
                          <!-- 배송정책명 입력 -->
                          <div class="col-md-1">
                            <input type="text" class="form-control" name="SEARCH_DELIVERY_NM" id="SEARCH_DELIVERY_NM" placeholder="배송정책명 입력">                            
                          </div>
    ...
    <div class="row">
      ...
      <div class="col-lg-6 clearfix">
        <div class="form-inline f-right">
          <!-- 엑셀다운로드-->
          <button type="button" class="btn btn-default" onclick="showDeliverySetting()">통합배송정책</button>
