...
?>
 ...
 <div class="container-fluid mb20px">
    <h3 class="nwt-category"><small>쇼핑몰관리&nbsp;&nbsp;></small>거래처 관리</h3>
  </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-2 frmGroup3">
                            ...
                            <select class="form-control input-md" id="period " name="period">
                              ...
                              <option value="EDIT_DAY">등록일</option>
                            </select>
                            <!-- 날짜선택 -->
                          ...
                          <div class="col-md-1 frmGroup1">
                            <input type="text" class="form-control" name="SEARCH_PAYMENT_DATE" id="SEARCH_PAYMENT_DATE" placeholder="결제기일 입력">   
                            <span class="glyphicon glyphicon-calendar search-glypicon"></span>                         
                          </div>
                          ...
                          <!-- 계좌여부 -->
                          <div class="col-md-1">
                              <label for="deal_state" class="sr-only">계좌여부</label>
                              <select class="form-control" id="deal_state" name="deal_state">
                          ...
                          <!-- 거래상태 -->
                          <div class="col-md-1">
                              <label for="deal_state" class="sr-only">거래상태</label>
                              <select class="form-control" id="deal_state" name="deal_state">
