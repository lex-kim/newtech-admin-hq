<?php
	...
	require_once "../class/InOutOrder.php";
	
	switch( $_REQUEST['REQ_MODE'] ){
		case CASE_READ:  // 배송비 조회
			$result = $cInOutOrder->getDeliveryFeePrice($_REQUEST);
		...
		case CASE_DELETE:
			$result = $cInOutOrder->delData($_REQUEST);
		...
		case CASE_CREATE:
			$result = $cInOutOrder->setData($_REQUEST);
