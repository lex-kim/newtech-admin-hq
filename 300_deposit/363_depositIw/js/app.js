const DEPOSIT_URL = 'act/depositIw_act.php';
let CURR_PAGE = 1;
let tdLength = 0;
...
$(document).ready(function(){
    ...
    // const date = new Date();
    // $( "#START_DT_SEARCH").datepicker('setDate', date.getFullYear()+'-01-01'); 
    // $( "#END_DT_SEARCH").datepicker('setDate', 'today'); 
...
excelDownload = () =>{
    location.href="depositIwExcel.html?"+$("#searchForm").serialize();
}