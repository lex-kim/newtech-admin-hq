const ajaxUrl = 'act/iwList_act.php';
let CURR_PAGE = 1;
...
$(document).ready(function(){
    ...
    getRefOptions(GET_REF_CONTRACT_TYPE, 'RCT_ID_SEARCH', false, false); 
...
excelDownload = () => {
    location.href="iwListExcel.html?"+$("#searchForm").serialize()+"&REQ_MODE="+CASE_TOTAL_LIST;
}
