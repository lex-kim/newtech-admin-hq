<?
    ...
    $fnSRC =  (array_key_exists('HTTP_X_FORWARDED_PROTO', $_SERVER) ? 'https' : 'http') . '://'.$_SERVER['HTTP_HOST']."/PDF_VIEW.html?MGG_ID=".$_REQUEST['MGG_ID']."&NB_ID=".$_REQUEST['NB_ID']."&TYPE=".$_REQUEST['TYPE'];
